(function () {
  ...
  var META = {
    en: {
      lang: "en",
      title: "Small Town Jump | Bounce houses & water slides · Nixon, TX",
      description:
        "Small Town Jump in Nixon, TX — wet and dry inflatables for backyard parties. Call or text Sonny and Gloria at (830) 857-4742. Prices vary on location.",
    },
    es: {
      lang: "es",
      title: "Small Town Jump | Casas de brinco y resbaladeros · Nixon, TX",
      description:
        "Small Town Jump en Nixon, TX — inflables mojados y secos para fiestas. Llame o mande mensaje a Sonny y Gloria al (830) 857-4742. Los precios varían según el lugar.",
    },
  };
  ...
  var STORAGE_KEY = "stj-accent";
  var STORAGE_HEX = "stj-accent-hex";
  ...
  function syncCustomUi(hex, on) {
    ...
    if (sw) sw.style.background = hex || "#e31b23";
  ...
  function applyAccent(name) {
    ...
    var meta = document.querySelector('meta[name="theme-color"]');
    if (meta) meta.setAttribute("content", ACCENTS[key] || "#e31b23");
    document.querySelectorAll("#themeMenu [data-accent]").forEach(function (btn) {
      var on = btn.getAttribute("data-accent") === key;
      btn.classList.toggle("is-active", on);
      btn.setAttribute("aria-checked", on ? "true" : "false");
    });
    syncCustomUi("#e31b23", false);
  }
  ...
  function initThemeMenu() {
    ...
    if (!window.__stjThemeDocBound) {
      window.__stjThemeDocBound = true;
